<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editNews.aspx.cs" Inherits="BAG.admin.editNews" %>
...
<body class="adminbody" onload="bagnews.insertIframe();">
    ...
    <div class="admin_right" id="view_base" runat="server">
        ...
        <div class="adminButton">            
            <span id="saveButton" runat="server" onclick="bagnews.saveNewNews('-1')">Сохранить</span>
            <a href="news.aspx">Отмена</a>
        </div>
    </div>
