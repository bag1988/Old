...
{
    public partial class blocknews : System.Web.UI.UserControl
    {
        ...
        void viewBase()
        {
            try
            {
                ...
                lis = b.connect("selectNews", new string[] { idPage, maxView });
                if (lis.Count > 0)
                {
                    ...
                    if (nameBlock != "")
                    {
                        ...
                        viewNews.Controls.Add(a);
                    }
                    for (int i = 0; i < lis.Count; i++)
                    {
                        HtmlGenericControl div = new HtmlGenericControl("div");
                        a = new HtmlGenericControl("a");
                        a.Attributes.Add("href", pageView + "?news=" + lis[i].ElementAt(0).Value);
