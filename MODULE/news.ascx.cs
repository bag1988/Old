        ...
        void viewBase()
        {
            ...
            if (lis.Count > 0)
            {
                for (int i = 0; i < lis.Count; i++)
                {
                    ...
                    a.Attributes.Add("href", this.Page.Request.FilePath+"?news="+lis[i].ElementAt(0).Value);
            ...
            if (lis.Count > 0)
            {
                viewNews.Controls.Add(b.getNavigationView(lis[0].ElementAt(0).Value, idPage, Convert.ToInt32(maxView), this.Page.Request.FilePath));
            }
